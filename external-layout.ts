        ...
        return new Promise((resolve, reject) => {
            ...
            process.on('close', (code) => {
                ...
                try {
                    ...
                    if (result.error) {
                        new Notice(`Python Error: ${result.error}`);
                    ...
                    console.error("Raw Output was:", stdoutData);
                    console.error("Parse Error:", e);
                    new Notice("Failed to parse PDF layout data.");
                    resolve(null);
                }
            });
            ...
            process.on('error', (err) => {
                ...
                new Notice("Could not start Python process. Check your path.");
                resolve(null);
            });
        });
    }
